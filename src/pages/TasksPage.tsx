...
type TabOption = (typeof TabOptions)[keyof typeof TabOptions];

export const TasksPage = () => {
  const [selectedTab, setSelectedTab] = useState<TabOption>(TabOptions.ALL);
  ...
  return (
    <div className="flex w-full max-w-5xl px-6 flex-col gap-4 flex-1 mx-auto">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex justify-end items-center gap-4">
              ...
              <Button
                ...
                onPress={() => void handleSubmit(handleAddNote)()}
                isLoading={isLoading}
              >
                Create task
              </Button>
      ...
      <Tabs
        ...
        className="flex"
        size="lg"
        onSelectionChange={(key: Key) => setSelectedTab(key as TabOption)}
      >
